 ...
 * Broglio Matteo
 *
 * Il programma genere un file rubrica.txt in formato CSV, 
 * e quindi permette ad Outlook o Mozilla di  importare i contatti.
 *
 */
...
struct elemento *lista = NULL;
  ...
  { // FOR - OPEN
    ...
    { // IF - OPEN
      ...
      printf ("--------------------------------------\n");
      printf (" Programma creato da Broglio Matteo\n");
      printf ("--------------------------------------\n\n");
      break;
